...
var aggregate_root_1 = require("../entities/aggregate-root");
var domain_events_1 = require("@/core/events/domain-events");
var vitest_1 = require("vitest");
var CustomAggregateCreated = /** @class */ (function () {
    function CustomAggregateCreated(aggregate) {
        this.aggregate = aggregate;
        this.ocurredAt = new Date();
    }
    CustomAggregateCreated.prototype.getAggregateId = function () {
        return this.aggregate.id;
    };
    return CustomAggregateCreated;
}());
var CustomAggregate = /** @class */ (function (_super) {
    ...
    CustomAggregate.create = function () {
        var aggregate = new CustomAggregate(null);
...
describe('domain events', function () {
    it('should be able to dispatch and listen to events', function () { return __awaiter(void 0, void 0, void 0, function () {
        var callbackSpy, aggregate;
        return __generator(this, function (_a) {
            callbackSpy = vitest_1.vi.fn();
