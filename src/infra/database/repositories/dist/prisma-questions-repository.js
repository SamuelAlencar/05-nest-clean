...
var PrismaQuestionsRepository = /** @class */ (function () {
    function PrismaQuestionsRepository(prisma, questionAttachmentsRepository) {
        this.prisma = prisma;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, prisma_question_details_mapper_1.PrismaQuestionDetailsMapper.toDomain(question)];
                }
            });
        });
    };
