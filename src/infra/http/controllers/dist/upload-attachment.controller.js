...
var UploadAttachmentController = /** @class */ (function () {
    ...
    __decorate([
        ...
        __param(0, common_1.UploadedFile(new common_1.ParseFilePipe({
            validators: [
    ...
    ], UploadAttachmentController.prototype, "handle");
    UploadAttachmentController = __decorate([
        common_1.Controller('/attachments')
    ], UploadAttachmentController);
    return UploadAttachmentController;
}());
