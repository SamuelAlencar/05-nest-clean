...
describe('Answer question (E2E)', function () {
    var app;
    var prisma;
    var studentFactory;
    var questionFactory;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        ...
                        providers: [make_student_1.StudentFactory, make_question_1.QuestionFactory, make_attachment_1.AttachmentFactory]
                    }).compile()];
                case 1:
                    moduleRef = _a.sent();
    ...
    test('[POST] /questions/:questionId/answers', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, accessToken, question, questionId, attachment1, attachment2, response, answerOnDatabase, attachmentsOnDatabase;
        return __generator(this, function (_a) {
            switch (_a.label) {
