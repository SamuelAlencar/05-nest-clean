...
describe('Delete question (E2E)', function () {
    var app;
    var prisma;
    var studentFactory;
    var questionFactory;
    ...
    test('[DELETE] /questions/:id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, accessToken, question, questionId, response, questionOnDatabase;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, supertest_1["default"](app.getHttpServer())["delete"]("/questions/" + questionId)
                            .set('Authorization', "Bearer " + accessToken)];
                case 3:
                    response = _a.sent();
                    expect(response.statusCode).toBe(204);
                    return [4 /*yield*/, prisma.question.findUnique({
                            where: {
                                id: questionId
                            }
                        })];
                case 4:
                    questionOnDatabase = _a.sent();
