...
describe('Edit answer (E2E)', function () {
    var app;
    var prisma;
    var studentFactory;
    var questionFactory;
            ...
            switch (_a.label) {
                case 0: return [4 /*yield*/, testing_1.Test.createTestingModule({
                        ...
                        providers: [
                            ...
                            make_answer_1.AnswerFactory,
                            make_attachment_1.AttachmentFactory,
                            make_answer_attachments_1.AnswerAttachmentFactory,
                        ]
                    }).compile()];
                case 1:
                    moduleRef = _a.sent();
                    ...
                    answerAttachmentFactory = moduleRef.get(make_answer_attachments_1.AnswerAttachmentFactory);
    ...
    test('[PUT] /answers/:id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, accessToken, question, answer, attachment1, attachment2, attachment3, answerId, response, answerOnDatabase, attachmentsOnDatabase;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    attachment2 = _a.sent();
                    return [4 /*yield*/, answerAttachmentFactory.makePrismaAnswerAttachment({
                ...
                case 9:
                    ...
                    return [4 /*yield*/, prisma.answer.findFirst({
                            where: {
                                content: 'New answer content'
                            }
                        })];
                case 10:
                    answerOnDatabase = _a.sent();
                    expect(answerOnDatabase).toBeTruthy();
                    return [4 /*yield*/, prisma.attachment.findMany({
                            where: {
                                answerId: answerOnDatabase === null || answerOnDatabase === void 0 ? void 0 : answerOnDatabase.id
                            }
                        })];
                case 11:
                    attachmentsOnDatabase = _a.sent();
