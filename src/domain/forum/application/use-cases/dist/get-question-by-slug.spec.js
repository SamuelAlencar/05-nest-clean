...
var get_question_by_slug_1 = require("./get-question-by-slug");
...
describe('Get Question By Slug', function () {
    beforeEach(function () {
        ...
        sut = new get_question_by_slug_1.GetQuestionBySlugUseCase(inMemoryQuestionsRepository);
    });
    it('should be able to get a question by slug', function () { return __awaiter(void 0, void 0, void 0, function () {
        var newQuestion, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    newQuestion = make_question_1.makeQuestion({
                        slug: slug_1.Slug.create('example-question')
                    });
