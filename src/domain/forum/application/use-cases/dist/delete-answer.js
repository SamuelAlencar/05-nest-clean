...
var DeleteAnswerUseCase = /** @class */ (function () {
    function DeleteAnswerUseCase(answersRepository) {
        this.answersRepository = answersRepository;
    }
    DeleteAnswerUseCase.prototype.execute = function (_a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.answersRepository["delete"](answer)];
                    case 2:
                        _b.sent();
