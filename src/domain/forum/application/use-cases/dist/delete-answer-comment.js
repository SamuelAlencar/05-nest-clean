...
var DeleteAnswerCommentUseCase = /** @class */ (function () {
    function DeleteAnswerCommentUseCase(answerCommentsRepository) {
        this.answerCommentsRepository = answerCommentsRepository;
    }
    DeleteAnswerCommentUseCase.prototype.execute = function (_a) {
        var authorId = _a.authorId, answerCommentId = _a.answerCommentId;
        return __awaiter(this, void 0, Promise, function () {
            var answerComment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.answerCommentsRepository.findById(answerCommentId)];
                    case 1:
                        answerComment = _b.sent();
                        if (!answerComment) {
                        ...
                        return [4 /*yield*/, this.answerCommentsRepository["delete"](answerComment)];
                    case 2:
                        _b.sent();
    ...
    DeleteAnswerCommentUseCase = __decorate([
        common_1.Injectable()
    ], DeleteAnswerCommentUseCase);
    return DeleteAnswerCommentUseCase;
}());
