...
var edit_answer_1 = require("./edit-answer");
...
describe('Edit Answer', function () {
    beforeEach(function () {
        ...
        sut = new edit_answer_1.EditAnswerUseCase(inMemoryAnswersRepository, inMemoryAnswerAttachmentsRepository);
    });
    it('should be able to edit a answer', function () { return __awaiter(void 0, void 0, void 0, function () {
        var newAnswer;
    ...
    it('should not be able to edit a answer from another user', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it('should sync new and removed attachment when editing an answer', function () { return __awaiter(void 0, void 0, void 0, function () {
        var newAnswer, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
