...
var CommentOnQuestionUseCase = /** @class */ (function () {
    function CommentOnQuestionUseCase(questionsRepository, questionCommentsRepository) {
        this.questionsRepository = questionsRepository;
        this.questionCommentsRepository = questionCommentsRepository;
    }
    CommentOnQuestionUseCase.prototype.execute = function (_a) {
        var authorId = _a.authorId, questionId = _a.questionId, content = _a.content;
        return __awaiter(this, void 0, Promise, function () {
            var question, questionComment;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.questionsRepository.findById(questionId)];
                    case 1:
                        question = _b.sent();
                        if (!question) {
                            return [2 /*return*/, either_1.left(new resource_not_found_error_1.ResourceNotFoundError())];
                        }
                        questionComment = question_comment_1.QuestionComment.create({
                            authorId: new unique_entity_id_1.UniqueEntityID(authorId),
                            questionId: new unique_entity_id_1.UniqueEntityID(questionId),
                            content: content
                        });
                        return [4 /*yield*/, this.questionCommentsRepository.create(questionComment)];
                    case 2:
                        _b.sent();
    ...
    CommentOnQuestionUseCase = __decorate([
        common_1.Injectable()
    ], CommentOnQuestionUseCase);
    return CommentOnQuestionUseCase;
}());
