...
var DeleteQuestionUseCase = /** @class */ (function () {
    function DeleteQuestionUseCase(questionsRepository) {
        this.questionsRepository = questionsRepository;
    }
    DeleteQuestionUseCase.prototype.execute = function (_a) {
        var questionId = _a.questionId, authorId = _a.authorId;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.questionsRepository["delete"](question)];
                    case 2:
                        _b.sent();
