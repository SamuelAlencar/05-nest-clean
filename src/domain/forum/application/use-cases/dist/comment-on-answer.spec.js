...
var in_memory_answer_comments_repository_1 = require("test/repositories/in-memory-answer-comments-repository");
...
var inMemoryAnswerCommentsRepository;
var sut;
describe('Comment on Answer', function () {
    beforeEach(function () {
        ...
        inMemoryAnswerCommentsRepository = new in_memory_answer_comments_repository_1.InMemoryAnswerCommentsRepository();
        sut = new comment_on_answer_1.CommentOnAnswerUseCase(inMemoryAnswersRepository, inMemoryAnswerCommentsRepository);
    });
    it('should be able to comment on answer', function () { return __awaiter(void 0, void 0, void 0, function () {
        var answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    answer = make_answer_1.makeAnswer();
                    return [4 /*yield*/, inMemoryAnswersRepository.create(answer)];
                case 1:
                    _a.sent();
