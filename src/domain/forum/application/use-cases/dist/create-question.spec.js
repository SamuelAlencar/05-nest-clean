...
var create_question_1 = require("./create-question");
...
describe('Create Question', function () {
    beforeEach(function () {
        ...
        sut = new create_question_1.CreateQuestionUseCase(inMemoryQuestionsRepository);
    });
    it('should be able to create a question', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    expect(inMemoryQuestionsRepository.items[0]).toEqual((_a = result.value) === null || _a === void 0 ? void 0 : _a.question);
    ...
    it('should persist attachments when creating a new question', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
